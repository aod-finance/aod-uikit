...
var Icon$x = function (props) {
    return React__default['default'].createElement("img", __assign({ width: "64px", height: "64px", src: "/images/price-token.png" }, props));
};
...
var Icon$N = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React__default['default'].createElement("path", { d: "M23.127 10.987l-6.122-6.125c-.51-.51-1.35-.51-1.871 0-.51.51-.51 1.35 0 1.872l1.279 1.28-3.197 3.21-1.22-1.22a2.222 2.222 0 00-3.138 0L6.37 12.492a6.46 6.46 0 000 9.135 6.451 6.451 0 009.13 0l2.487-2.488a2.225 2.225 0 000-3.14L16.78 14.79l3.209-3.21 1.279 1.28c.509.509 1.35.509 1.87 0 .51-.522.51-1.363-.011-1.873zm-9.568 4.526l-4.607 4.609a.751.751 0 01-.544.225.751.751 0 01-.545-.225.78.78 0 010-1.09l4.606-4.609a.779.779 0 011.09 0 .759.759 0 010 1.09z" })));
};
...
var Icon$T = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React__default['default'].createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M15.657 6.65c.133-1.252-.481-2.694-1.74-2.64a10.346 10.346 0 00-8.665 5.439c-2.746 5.074-.9 11.437 4.12 14.208 5.018 2.771 11.32.915 14.066-4.16a10.506 10.506 0 001.252-5.679c-.05-.804-.96-1.187-1.738-.973a5.787 5.787 0 01-7.295-6.195zm.697 4.112c-2.027-1.12-4.577-.363-5.684 1.681-1.108 2.045-.361 4.62 1.666 5.74s4.577.364 5.684-1.68c1.105-2.046.36-4.621-1.666-5.741z" })));
};
...
var Icon$Y = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("path", { d: "M5.485 12.52A6.625 6.625 0 018.278 8.14a4.615 4.615 0 01-.395-1.042 7.725 7.725 0 00-3.51 5.545 4.34 4.34 0 011.02-.121h.092zm13.104 0c.384.01.759.071 1.123.172a7.748 7.748 0 00-3.299-5.454c-.1.358-.246.702-.435 1.022a6.695 6.695 0 012.61 4.26zm-3.633 7.063c-.91.446-1.91.678-2.924.678a6.492 6.492 0 01-3.066-.759c-.222.304-.48.58-.77.82a7.716 7.716 0 007.55.07 4.27 4.27 0 01-.79-.809zM8.683 5.922a3.534 3.534 0 107.07 0 3.534 3.534 0 00-7.07 0zM1.792 16.95a3.535 3.535 0 107.07 0 3.535 3.535 0 00-7.07 0zM14.93 16.95a3.534 3.534 0 107.068 0 3.534 3.534 0 00-7.067 0z" })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(IconContainer, null,
        React__default['default'].createElement("img", __assign({}, props, { src: "/images/logo.png", alt: "AOD logo", width: "512", height: "512" }))));
};
...
var Icon$13 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement("path", { d: "M9.08 30a8.3 8.3 0 01-4.48-1.55 8.39 8.39 0 01-3.52-5.53 3.32 3.32 0 01.39-2.58 1.37 1.37 0 011.66-.43c1.31.52 2.76 3 3.33 4.09.62 1.21 1.24 1.58 1.62 1.55S9 25 9.33 23.69a4.7 4.7 0 00-.15-2.08l-.09-.41c-.15-.73-.35-1.41-.54-2.07A11.88 11.88 0 017.89 14c.47-3.82 2-6.19 4.62-7.24a4 4 0 011.05-.2.76.76 0 01.71.35.8.8 0 010 .79 8.12 8.12 0 00-.74 6.12v.05a8 8 0 002.86 4.21.77.77 0 01-.32 1.37 2.75 2.75 0 00-1.64.9 3.27 3.27 0 00-.73 2.69 16.14 16.14 0 01-.05 2.13c-.24 2.69-1.53 3.84-2.56 4.34a4.7 4.7 0 01-2.01.49zm-6.45-8.62a2.66 2.66 0 000 1.3 7 7 0 002.85 4.49c1.83 1.2 3.75 1.57 5 1 1-.47 1.55-1.51 1.7-3.09a16.9 16.9 0 000-2 4.71 4.71 0 011.08-3.69 3.74 3.74 0 011.19-1 9.48 9.48 0 01-2.38-4.1v-.05a9.72 9.72 0 01.13-5.63c-1.55 1-2.45 2.78-2.79 5.56A10.43 10.43 0 0010 18.7c.2.69.41 1.4.57 2.19l.08.39a5.77 5.77 0 01.14 2.79c-.46 1.78-1.39 2.88-2.57 3-.69.07-2-.12-3.16-2.36a10.23 10.23 0 00-2.43-3.33zm-.56-.57l.6.48z" }),
        React__default['default'].createElement("path", { d: "M21.38 21.31a9.7 9.7 0 01-5.88-2 9.48 9.48 0 01-3.4-5v-.05A9.71 9.71 0 0113 7v-.06A9.64 9.64 0 1124 21a9.9 9.9 0 01-2.62.31zm-7.82-7.48v.05a8 8 0 002.86 4.21A8.08 8.08 0 1014.3 7.71a8.12 8.12 0 00-.74 6.12zm.07-6.5z" }),
        React__default['default'].createElement("path", { d: "M23.53 6.18a4.17 4.17 0 01.88 8.24 4.58 4.58 0 01-.89.1 4.17 4.17 0 01-.88-8.25 4.48 4.48 0 01.89-.09m0-1.55a6.24 6.24 0 00-1.22.13 5.73 5.73 0 00-4.37 6.8 5.74 5.74 0 005.58 4.5 6.24 6.24 0 001.22-.13 5.72 5.72 0 00-1.21-11.3z" }),
        React__default['default'].createElement("ellipse", { cx: 24.81, cy: 9.23, rx: 1.38, ry: 1.85, transform: "rotate(-54.16 24.812 9.232)" }),
        React__default['default'].createElement("ellipse", { cx: 23.1, cy: 11.88, rx: 0.47, ry: 0.65, transform: "rotate(-54.16 23.103 11.874)" })));
};
...
var Logo$1 = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        ...
        React__default['default'].createElement(Logo, { className: "mobile-icon", isDark: isDark, isPushed: isPushed })));
    var _b = useMatchBreakpoints(), isXl = _b.isXl; _b.isNav;
    var isMobile = isXl === false;
    return !isMobile ? (React__default['default'].createElement(Flex, { alignItems: "center" },
        ...
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, isPushed: isPushed, "aria-label": "Baker home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink$1, { to: href, isPushed: isPushed, "aria-label": "Baker home page" }, innerLogo)))) : (React__default['default'].createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, isPushed: isPushed, "aria-label": "Baker home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink$1, { to: href, isPushed: isPushed, "aria-label": "Baker home page" }, innerLogo))));
};
...
var NewIcon = styled__default['default'](Icon$1h)(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  position: absolute;\n  left: 155px;\n  width: 40px;\n  margin-right: 45px;\n  animation: ", " 6s infinite;\n"], ["\n  position: absolute;\n  left: 155px;\n  width: 40px;\n  margin-right: 45px;\n  animation: ", " 6s infinite;\n"])), rotate$1);
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, null,
        ...
        React__default['default'].createElement(Link, { href: "https://ftmscan.com/token/0x7Ad70C360f28A445286D37214Bbd72D9dc492B9b", style: { marginLeft: "5px", textDecoration: "none" }, target: "_blank", color: "textSubtle", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
...
styled__default['default'].div(templateObject_2$g || (templateObject_2$g = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  //justify-content: space-between;\n  justify-content: flex-start;\n  height: ", "px;\n  //padding: 0 8px;\n"], ["\n  display: flex;\n  align-items: center;\n  //justify-content: space-between;\n  justify-content: flex-start;\n  height: ", "px;\n  //padding: 0 8px;\n"])), MENU_ENTRY_HEIGHT);
...
var AuditBadge = function (_a) {
    var isPushed = _a.isPushed;
    return (React__default['default'].createElement(Wrapper$1, { className: "audit-badge", href: "#", rel: "noreferrer", target: "_blank", isPushed: isPushed },
        React__default['default'].createElement("span", null, "audited by"),
        React__default['default'].createElement("img", { alt: "Logo", className: "logo", src: "https://solidity.finance/images/logo.svg" })));
};
...
var connectors = [
    ...
    },
    {
        ...
        icon: Icon$1s,
        connectorId: exports.ConnectorNames.FANTOM,
    },
    {
