...
var Icon$x = function (props) {
    return React.createElement("img", __assign({ width: "64px", height: "64px", src: "/images/price-token.png" }, props));
};
...
var RotatingPancakeIcon = styled(Icon$M)(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var FloatingPanIcon = styled(Icon$L)(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  position: absolute;\n  top: 40px;\n"], ["\n  position: absolute;\n  top: 40px;\n"])));
...
var Icon$N = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React.createElement("path", { d: "M23.127 10.987l-6.122-6.125c-.51-.51-1.35-.51-1.871 0-.51.51-.51 1.35 0 1.872l1.279 1.28-3.197 3.21-1.22-1.22a2.222 2.222 0 00-3.138 0L6.37 12.492a6.46 6.46 0 000 9.135 6.451 6.451 0 009.13 0l2.487-2.488a2.225 2.225 0 000-3.14L16.78 14.79l3.209-3.21 1.279 1.28c.509.509 1.35.509 1.87 0 .51-.522.51-1.363-.011-1.873zm-9.568 4.526l-4.607 4.609a.751.751 0 01-.544.225.751.751 0 01-.545-.225.78.78 0 010-1.09l4.606-4.609a.779.779 0 011.09 0 .759.759 0 010 1.09z" })));
};
...
var Icon$T = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M15.657 6.65c.133-1.252-.481-2.694-1.74-2.64a10.346 10.346 0 00-8.665 5.439c-2.746 5.074-.9 11.437 4.12 14.208 5.018 2.771 11.32.915 14.066-4.16a10.506 10.506 0 001.252-5.679c-.05-.804-.96-1.187-1.738-.973a5.787 5.787 0 01-7.295-6.195zm.697 4.112c-2.027-1.12-4.577-.363-5.684 1.681-1.108 2.045-.361 4.62 1.666 5.74s4.577.364 5.684-1.68c1.105-2.046.36-4.621-1.666-5.741z" })));
};
...
var Icon$Y = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { d: "M5.485 12.52A6.625 6.625 0 018.278 8.14a4.615 4.615 0 01-.395-1.042 7.725 7.725 0 00-3.51 5.545 4.34 4.34 0 011.02-.121h.092zm13.104 0c.384.01.759.071 1.123.172a7.748 7.748 0 00-3.299-5.454c-.1.358-.246.702-.435 1.022a6.695 6.695 0 012.61 4.26zm-3.633 7.063c-.91.446-1.91.678-2.924.678a6.492 6.492 0 01-3.066-.759c-.222.304-.48.58-.77.82a7.716 7.716 0 007.55.07 4.27 4.27 0 01-.79-.809zM8.683 5.922a3.534 3.534 0 107.07 0 3.534 3.534 0 00-7.07 0zM1.792 16.95a3.535 3.535 0 107.07 0 3.535 3.535 0 00-7.07 0zM14.93 16.95a3.534 3.534 0 107.068 0 3.534 3.534 0 00-7.067 0z" })));
};
...
var Logo = function (_a) {
    _a.isDark; _a.isPushed; var props = __rest(_a, ["isDark", "isPushed"]);
    return (React.createElement(IconContainer, null,
        React.createElement("img", __assign({}, props, { src: "/images/logo.png", alt: "AOD logo", width: "512", height: "512" }))));
};
...
var Icon$13 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("path", { d: "M9.08 30a8.3 8.3 0 01-4.48-1.55 8.39 8.39 0 01-3.52-5.53 3.32 3.32 0 01.39-2.58 1.37 1.37 0 011.66-.43c1.31.52 2.76 3 3.33 4.09.62 1.21 1.24 1.58 1.62 1.55S9 25 9.33 23.69a4.7 4.7 0 00-.15-2.08l-.09-.41c-.15-.73-.35-1.41-.54-2.07A11.88 11.88 0 017.89 14c.47-3.82 2-6.19 4.62-7.24a4 4 0 011.05-.2.76.76 0 01.71.35.8.8 0 010 .79 8.12 8.12 0 00-.74 6.12v.05a8 8 0 002.86 4.21.77.77 0 01-.32 1.37 2.75 2.75 0 00-1.64.9 3.27 3.27 0 00-.73 2.69 16.14 16.14 0 01-.05 2.13c-.24 2.69-1.53 3.84-2.56 4.34a4.7 4.7 0 01-2.01.49zm-6.45-8.62a2.66 2.66 0 000 1.3 7 7 0 002.85 4.49c1.83 1.2 3.75 1.57 5 1 1-.47 1.55-1.51 1.7-3.09a16.9 16.9 0 000-2 4.71 4.71 0 011.08-3.69 3.74 3.74 0 011.19-1 9.48 9.48 0 01-2.38-4.1v-.05a9.72 9.72 0 01.13-5.63c-1.55 1-2.45 2.78-2.79 5.56A10.43 10.43 0 0010 18.7c.2.69.41 1.4.57 2.19l.08.39a5.77 5.77 0 01.14 2.79c-.46 1.78-1.39 2.88-2.57 3-.69.07-2-.12-3.16-2.36a10.23 10.23 0 00-2.43-3.33zm-.56-.57l.6.48z" }),
        React.createElement("path", { d: "M21.38 21.31a9.7 9.7 0 01-5.88-2 9.48 9.48 0 01-3.4-5v-.05A9.71 9.71 0 0113 7v-.06A9.64 9.64 0 1124 21a9.9 9.9 0 01-2.62.31zm-7.82-7.48v.05a8 8 0 002.86 4.21A8.08 8.08 0 1014.3 7.71a8.12 8.12 0 00-.74 6.12zm.07-6.5z" }),
        React.createElement("path", { d: "M23.53 6.18a4.17 4.17 0 01.88 8.24 4.58 4.58 0 01-.89.1 4.17 4.17 0 01-.88-8.25 4.48 4.48 0 01.89-.09m0-1.55a6.24 6.24 0 00-1.22.13 5.73 5.73 0 00-4.37 6.8 5.74 5.74 0 005.58 4.5 6.24 6.24 0 001.22-.13 5.72 5.72 0 00-1.21-11.3z" }),
        React.createElement("ellipse", { cx: 24.81, cy: 9.23, rx: 1.38, ry: 1.85, transform: "rotate(-54.16 24.812 9.232)" }),
        React.createElement("ellipse", { cx: 23.1, cy: 11.88, rx: 0.47, ry: 0.65, transform: "rotate(-54.16 23.103 11.874)" })));
};
...
var Icon$1m = function (props) {
    return (React.createElement(Svg, { style: { marginRight: "8px" }, "aria-hidden": "true", focusable: "false", "data-prefix": "fas", "data-icon": "hand-holding-usd", role: "img", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 576 512" },
...
var IconModule = /*#__PURE__*/Object.freeze({
    ...
    VaultIcon: Icon$1d,
    StoreIcon: Icon$1e,
    AnalyticIcon: Icon$1f,
    DonateIcon: Icon$1g,
    BadgeNewIcon: Icon$1h,
    GaugeIcon: Icon$1i,
    inSpiritIcon: Icon$1j,
    NftZoo: Icon$1k,
    Rocket: Icon$1l,
    LendIcon: Icon$1m
});
...
var StyledLink$1 = styled(Link$1)(templateObject_1$B || (templateObject_1$B = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n\n  & > div {\n    margin-left: 26px;\n    margin-top: 24px;\n\n    ", " {\n      margin-left: ", ";\n    }\n  }\n\n  .mobile-icon {\n    width: ", ";\n    height: auto;\n\n    ", " {\n      display: none;\n    }\n  }\n\n  .desktop-icon {\n    width: ", ";\n    height: auto;\n    display: none;\n\n    ", " {\n      display: block;\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n\n  & > div {\n    margin-left: 26px;\n    margin-top: 24px;\n\n    ", " {\n      margin-left: ", ";\n    }\n  }\n\n  .mobile-icon {\n    width: ", ";\n    height: auto;\n\n    ", " {\n      display: none;\n    }\n  }\n\n  .desktop-icon {\n    width: ", ";\n    height: auto;\n    display: none;\n\n    ", " {\n      display: block;\n    }\n  }\n"])), function (_a) {
    ...
    return isPushed ? '60px' : '6px';
}, function (_a) {
    var isPushed = _a.isPushed;
    return isPushed ? '90px' : '50px';
}, function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
}, function (_a) {
...
var Logo$1 = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        ...
        React.createElement(Logo, { className: "mobile-icon", isDark: isDark, isPushed: isPushed })));
    var _b = useMatchBreakpoints(), isXl = _b.isXl; _b.isNav;
    var isMobile = isXl === false;
    return !isMobile ? (React.createElement(Flex, { alignItems: "center" },
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, isPushed: isPushed, "aria-label": "Baker home page" }, innerLogo)) : (React.createElement(StyledLink$1, { to: href, isPushed: isPushed, "aria-label": "Baker home page" }, innerLogo)))) : (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, isPushed: isPushed, "aria-label": "Baker home page" }, innerLogo)) : (React.createElement(StyledLink$1, { to: href, isPushed: isPushed, "aria-label": "Baker home page" }, innerLogo))));
};
...
var socials = [
    {
        label: "Youtube",
        icon: "YoutubeIcon",
        href: "https://www.youtube.com/watch?v=PBwAxmrE194",
    },
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/ageofdefi",
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/AgeDefi",
    },
];
var MENU_HEIGHT = 64;
...
var MenuEntry = styled.div(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  font-weight: ", ";\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 400% 100%;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  font-weight: ", ";\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ",
    ...
    var secondary = _a.secondary;
    return (secondary ? "normal" : "bold");
}, function (_a) {
    var secondary = _a.secondary, theme = _a.theme;
    return (secondary ? theme.colors.background : "transparent");
}, function (_a) {
    var theme = _a.theme, secondary = _a.secondary;
    return secondary ? '#c1413c' : theme.colors.textSubtle;
}, function (_a) {
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { onClick: handleClick, className: className, inSpirit: inSpirit },
            icon,
            React.createElement(LinkLabelMemo, { isPushed: isPushed, inSpirit: inSpirit }, label),
...
var NewIcon = styled(Icon$1h)(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  position: absolute;\n  left: 155px;\n  width: 40px;\n  margin-right: 45px;\n  animation: ", " 6s infinite;\n"], ["\n  position: absolute;\n  left: 155px;\n  width: 40px;\n  margin-right: 45px;\n  animation: ", " 6s infinite;\n"])), rotate$1);
var MenuWrapper = styled.div(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n  align-items: center;\n"], ["\n  position: relative;\n  display: flex;\n  align-items: center;\n"])));
var PanelBody = function (_a) {
    ...
    return (React.createElement(Container$3, null, links.map(function (entry) {
        ...
        if (entry.items) {
            ...
            return (React.createElement(Accordion$1, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: initialOpenState, className: calloutClass, inSpirit: inSpiritLinks }, isPushed &&
                entry.items.map(function (item) { return (React.createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick, inSpirit: inSpiritLinks },
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, null,
        ...
        React.createElement(Link, { href: "https://ftmscan.com/token/0x7Ad70C360f28A445286D37214Bbd72D9dc492B9b", style: { marginLeft: "5px", textDecoration: "none" }, target: "_blank", color: "textSubtle", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
...
var AuditBadge = function (_a) {
    var isPushed = _a.isPushed;
    return (React.createElement(Wrapper$1, { className: "audit-badge", href: "#", rel: "noreferrer", target: "_blank", isPushed: isPushed },
        React.createElement("span", null, "audited by"),
        React.createElement("img", { alt: "Logo", className: "logo", src: "https://solidity.finance/images/logo.svg" })));
};
var templateObject_1$H;

var StyledPanel = styled.div(templateObject_1$I || (templateObject_1$I = __makeTemplateObject(["\n  position: fixed;\n  padding-top: \"80px\";\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background: ", ";\n  width: ", ";\n  height: 100vh;\n  transition: padding-top 0.2s, width 0.2s;\n  /* border-right: ", ";\n  border-right: ", "; */\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    border-width: 1px;\n    border-image: linear-gradient(to top, #7c5d1a, rgba(0, 0, 0, 0)) 0% 100%;\n    width: ", ";\n  }\n"], ["\n  position: fixed;\n  padding-top: \"80px\";\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background: ",
    ";\n  width: ", ";\n  height: 100vh;\n  transition: padding-top 0.2s, width 0.2s;\n  /* border-right: ", ";\n  border-right: ", "; */\n  border-right: ",
    ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    border-width: 1px;\n    border-image: linear-gradient(to top, #7c5d1a, rgba(0, 0, 0, 0)) 0% 100%;\n    width: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.isDark
    ...
    var isPushed = _a.isPushed;
    return (isPushed ? "2px solid #4e3836" : "2px solid #4e3836");
}, function (_a) {
    var isMobile = _a.isMobile;
    return (isMobile ? "2px solid #4e3836" : "none");
}, function (_a) {
    var isMobile = _a.isMobile, isPushed = _a.isPushed;
    switch (isMobile) {
        case true:
            return isPushed ? "2px solid #4e3836" : "none";
        case false:
            return isPushed ? "2px solid #4e3836" : "2px solid #4e3836";
    }
    return "";
...
var UserBlock = function (_a) {
    ...
    var OwnButton = styled(Button)(templateObject_1$L || (templateObject_1$L = __makeTemplateObject(["\n    border-radius: 0.5rem;\n    color: ", ";\n    box-shadow: 0 0 6px 0 rgba(157, 96, 212, 0.5);\n    border: solid 3px transparent;\n    background-image: linear-gradient(rgba(255,255,255,0),rgba(255,255,255,0)), linear-gradient(90deg,#e5b42b,#95782a)\n    background-origin: border-box;\n    background-clip: content-box, border-box;\n    box-shadow: ", ";\n  "], ["\n    border-radius: 0.5rem;\n    color: ", ";\n    box-shadow: 0 0 6px 0 rgba(157, 96, 212, 0.5);\n    border: solid 3px transparent;\n    background-image: linear-gradient(rgba(255,255,255,0),rgba(255,255,255,0)), linear-gradient(90deg,#e5b42b,#95782a)\n    background-origin: border-box;\n    background-clip: content-box, border-box;\n    box-shadow: ", ";\n  "])), function (_a) {
        var theme = _a.theme;
        return (theme.isDark ? "#e5b42b" : "#0d0e21");
    }, function (_a) {
        var theme = _a.theme;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#52D784", background: "#1F2B46", backgroundDisabled: "#424037", contrast: "#FFFFFF", invertedContrast: "#0D0F22", input: "#090a17", inputSecondary: "#8d8857", primaryDark: "#8f8104", tertiary: "#151e3199", text: "#452A7A", farmBackground: "#F4F3F6", toggleBackground: "#E6FDFE", textDisabled: "#544786", textSubtle: "#46357B", borderColor: "#61634b", card: "#0D0F22", nav: "#0D0F22", gradients: {
        bubblegum: "linear-gradient(139.73deg, #313D5C 0%, #3D2A54 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#52D784", background: "#1F2B46", backgroundDisabled: "#424037", contrast: "#FFFFFF", invertedContrast: "#0D0F22", input: "#090a17", inputSecondary: "#8d8857", primaryDark: "#8f8104", tertiary: "#151e3199", text: "#fcfae2", farmBackground: "#452A7A", toggleBackground: "#0D0F22", textDisabled: "#717161", textSubtle: "#cf2820", borderColor: "#61634b", card: "#0D0F22", nav: "#0D0F22", gradients: {
        bubblegum: "linear-gradient(139.73deg, #313D5C 0%, #3D2A54 100%)",
    } });
